...
if ($_POST!=NULL){
  ...
  $command="./runController ".escapeshellcmd($_POST["Kp"])." ".$sid;
...
?>
      ...
      <script type="text/javascript">	
	if(document.getElementById("ustate")!=null){
	document.write('<a id="displayText" href="javascript:toggle();">show counter</a>');
	var x = document.getElementById("ustate").innerHTML;
	x = x.replace(/^\s+|\s+$/g, "");	
	var porcent = 100*x;
	porcent = porcent.toFixed(1);
	...
	google.setOnLoadCallback(drawChart);
        ...
        function drawChart() {	
         ...
         data.addRows(3);
         data.setValue(0, 0, 'Ultim. St.');
         data.setValue(0, 1, 1*porcent);
         var chart = new google.visualization.Gauge(document.getElementById("chart_div"));
         var options = {width: 400, height: 190, redFrom: 90, redTo: 100,
