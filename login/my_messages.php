...
<? include('../sidebar.php'); ?>
            ...
            <div id="container">
                ...
                <div id="centercolumn">
                    <?if ($search_type == "received"){echo '<h3>My Received Messages</h3>';}else{echo '<h3>My Sent Messages</h3>';}?>
                    <div align="center">
                        <table class="fancy">
                            <?
                            $con = connect();
                            ...
                            if ($search_type == "received") {
                                ...
                                $query = "SELECT `id`, `rcpt_to` as `peer`,`subject`, `creation_date` from `message` where `from`='$un'";
                            }
