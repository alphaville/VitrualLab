...
onmouseover="tooltip.show(\'<strong>P(s)</strong> is the numerator of the transfer function of the system in vector form. For example, for P(s)=s<sup>2</sup>+3, write [1 0 3]\');" onmouseout="tooltip.hide();">P(s)</span>';
$__Q_HTML='<span class="hotspot" 
onmouseover="tooltip.show(\'<strong>Q(s)</strong> is the denominator of the transfer function of the system in vector form. For example, for P(s)=s<sup>2</sup>+3s+7, write [1 3 7]\');" onmouseout="tooltip.hide();">Q(s)</span>';
$__DELAY='<span class="hotspot" 
onmouseover="tooltip.show(\'The <strong>delay</strong> of the process.\');" onmouseout="tooltip.hide();">Delay</span>';
$__OPENLOOP_HTML='<span class="hotspot" 
onmouseover="tooltip.show(\'Check this box to run simulations on the open loop system (see figure)\');" onmouseout="tooltip.hide();">Open Loop</span>';
...
onmouseover="tooltip.show(\'Whether to plot the Nyquist Diagram of the System\');" onmouseout="tooltip.hide();">Nyquist Diagram</span>';
?>