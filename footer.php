<div id=html-valid>
    ...
    <img src="/images/compatible_safari.gif" class=compatibility title=Safari-Compatible alt=Safari-Compatible>
    <img src="/images/compatible_ie.gif" class=compatibility title=IE-Compatible alt=IE7-Compatible>
</div>
<div id=footer-info>
    <span class="hotspot footer-element" onmouseover="tooltip.show('National Technical University of Athens, Unit of Automatic Control and Informatics')" onmouseout="tooltip.hide()">
        <a href="http://www.chemeng.ntua.gr/labs/control_lab/">Automatic Control Lab, NTUA</a>
    </span>|
    <span class="hotspot footer-element" onmouseover="tooltip.show('Designed by Pantelis Sopasakis')" onmouseout="tooltip.hide()">
        <a href="http://gr.linkedin.com/in/sopasakis">Design by Pantelis Sopasakis</a>
    </span>|
    <span class="hotspot footer-element" onmouseover="tooltip.show('Source Code Hosted on Github')" onmouseout="tooltip.hide()">
        <a href="https://github.com/alphaville/VitrualLab">Source Code</a>
    </span>|
    <span class="hotspot footer-element" onmouseover="tooltip.show('GNU GPN v3 - Attribution, Non-Commercial Use, Free distribution')" onmouseout="tooltip.hide()">
