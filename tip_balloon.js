...
<a onmouseover="TagToTip('T2TBalloon', BALLOON, true, FADEIN, 400, FADEOUT, 
    400, ABOVE, true, WIDTH, 260, PADDING, 8, TEXTALIGN, 'justify', 
    OFFSETX, -10)" href="#extensions">Extensions (plugins)</a>
<span style="display: none;" id="T2TBalloon">For example, to create a 
    <b>balloon tooltip</b> like this one, just include the JavaScript plugin 
    "tip_balloon.js" into your page and apply the BALLOON command to the tooltip.
</span>
...
config. BalloonImgPath = "../balloon/" // Path to images (border, corners, stem), in quotes. Path must be relative to your HTML file.
